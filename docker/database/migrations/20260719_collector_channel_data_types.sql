...
CREATE TABLE IF NOT EXISTS collector_channel_data_types (
...
CREATE INDEX IF NOT EXISTS idx_ccdt_data_type_priority
    ON collector_channel_data_types(data_type, priority);

INSERT INTO collector_channel_data_types (channel_id, data_type, priority)
SELECT c.id, t.data_type, c.id
FROM collector_channel_configs c
