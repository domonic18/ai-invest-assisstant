...
class StockBasic(Base):
    ...
    industry_level_2: Mapped[str | None] = mapped_column(String(50), nullable=True)
    industry_level_3: Mapped[str | None] = mapped_column(String(50), nullable=True)
